...
const CustomerSelect = ({ open, onClose, onSelect }) => {
    ...
    useEffect(() => {
        ...
        const fetchCustomers = async () => {
            try {
                const data = await customersApi.getAllCustomers(search);
    ...
    const handleSave = async () => {
        ...
        try {
            let saved;
            if (formData.id) {
                saved = await customersApi.updateCustomer(formData.id, formData);
            } else {
                saved = await customersApi.createCustomer(formData);
            }
